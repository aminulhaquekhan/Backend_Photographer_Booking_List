        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
            ...
            <div class="flex gap-3 justify-center md:justify-end mt-4 md:mt-0">
                <a href="{{ route('users.edit', $user->id) }}" 
                   class="py-2 px-5 bg-blue-600 text-lg font-bold text-white rounded-lg hover:bg-blue-700 transition flex items-center gap-2">
                ...
                <form action="{{ route('users.destroy', $user->id) }}" method="POST" 
                    ...
                    @method('DELETE')
                    <button type="submit" 
                            class="py-2 px-5 bg-red-600 text-lg font-bold text-white rounded-lg hover:bg-red-700 transition flex items-center gap-2">
